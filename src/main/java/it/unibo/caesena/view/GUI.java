...
public class GUI extends JFrame implements UserInterface {
    ...
    public static final Font PLAYER_NUMBER_SELECTOR_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font PLAYER_NAME_START_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font PLAYER_NAME_INPUT_START_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font PLAYER_COLOR_START_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font PICK_COLOR_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font START_NEW_GAME_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font REMAINING_MEEPLES_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/90);
    public static final Font REMAINING_TILES_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/90);
    public static final Font PLAYER_NAME_GAME_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/90);
    public static final Font SCORE_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/90);
    public static final Font LEADERBOARD_HEADER_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/50);
    public static final Font LEADERBOARD_CONTENT_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font CONTROLS_BUTTON_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font PAUSE_HEADER_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font RESUME_PAUSE_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font BACK_TO_MENU_PAUSE_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font EXIT_PAUSE_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font EXIT_DIALOG_QUESTION_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font EXIT_DIALOG_ANSWER_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);
    public static final Font GAME_OVER_HEADER_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, Toolkit.getDefaultToolkit().getScreenSize().width/80);

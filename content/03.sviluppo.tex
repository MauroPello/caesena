...
\begin{itemize}
    ...
    \item Menù principale e di pausa (StartScene e PauseScene in it.unibo.
    caesena.view.scene)
    \item Vari componenti con scopi generici (in it.unibo.caesena.view.
    components.common)
    \item Componenti relativi al player (PlayerInput e PlayerImage in it.unibo.
    caesena.view.components.player)
    \item Ridimensionamento dinamico di FooterComponentImpl (in it.unibo.caesena.
    view.components)
    \item "Caching" delle immagini (RemainingMeeplesComponent in it.unibo.caesena.
    view.components.meeple)
...
\begin{itemize}
    ...
    \item Gestione del dimensionamento della GUI, in particolare del font, con Davide Speziali
    \item Color con Davide Speziali (package it.unibo.caesena.model)
    \item Gestione delle immagini dei seguaci con Davide Speziali (package it.unibo.
    caesena.view.components.meeple)
\end{itemize}

...
\begin{itemize}
    ...
    \item GameSetTileMediator (in it.unibo.caesena.model)
    \item Meeple (in it.unibo.caesena.model.meeple)
\end{itemize}
...
\begin{itemize}
    ...
    \item Tile con Samuele Giancarli (in it.unibo.caesena.model.tile)

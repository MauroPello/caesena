...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.9]{images/Progettazione/Logica/OP2-arrow.png}
\end{figure}
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.75]{images/Progettazione/Logica/OP18-arrow.png}
\end{figure}
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.75]{images/Progettazione/Logica/OP19-arrow.png}
\end{figure}
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.75]{images/Progettazione/Logica/OP20-arrow.png}
\end{figure}
\centerline{\begin{tabular}{ |l|c|c|c| }
\hline
\textbf{Concetto} & \textbf{Costrutto} & \textbf{Accessi} & \textbf{Tipo} \\
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.75]{images/Progettazione/Logica/OP21-arrow.png}
\end{figure}
\centerline{\begin{tabular}{ |l|c|c|c| }
\hline
\textbf{Concetto} & \textbf{Costrutto} & \textbf{Accessi} & \textbf{Tipo} \\
...
& & \textbf{Totale:} 17L $\to$ 700 al giorno & \\
\hline
\multicolumn{4}{|l|}{\textbf{Costo Totale} = 17*700 = \textbf{11900}} \\
\hline
\end{tabular}}
...
Placement & E & 1 & L \\
\hline
& & \textbf{Totale:} 25L $\to$ 700 al giorno & \\
\hline
\multicolumn{4}{|l|}{\textbf{Costo Totale} = 25*700 = \textbf{17500}} \\
\hline
\end{tabular}}

...
Si suppone che siano state giocate 10 partite alla quale hanno partecipato ogni volta 4 giocatori diversi. Le partite sono state giocate senza espansioni aggiuntive, quindi ogni giocatore possiede 8 seguaci e in una partita vengono giocate 62 tessere.
\medskip
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.8]{images/Progettazione/Logica/OP2-arrow.png}
\end{figure}
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.6]{images/Progettazione/Logica/OP18-arrow.png}
\end{figure}
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.7]{images/Progettazione/Logica/OP19-arrow.png}
\end{figure}
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.7]{images/Progettazione/Logica/OP20-arrow.png}
\end{figure}
\centerline{\begin{tabular}{ |l|c|c|c| }
\hline
\textbf{Concetto} & \textbf{Costrutto} & \textbf{Accessi} & \textbf{Tipo} \\
...
\begin{figure}[ht]
    \centering\includegraphics[scale=0.7]{images/Progettazione/Logica/OP21-arrow.png}
\end{figure}
\centerline{\begin{tabular}{ |l|c|c|c| }
\hline
\textbf{Concetto} & \textbf{Costrutto} & \textbf{Accessi} & \textbf{Tipo} \\

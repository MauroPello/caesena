...
\subsubsection{Operazione 1.1 - Ricerca giocatori}
    ...
    \medskip
    \centerline{\begin{tabular}{ |c|c|l|c| }
        \hline
        ...
        Player & E & 3 & L \\
        \hline
        Participation(Player-PlayerInGame) & R & 4 & S \\
        \hline
        PlayerInGame & R & 4 & S \\
        \hline
        Participation(PlayerInGame-Game) & R & 4 & S \\
        \hline
        Game & R & 1 & S \\
        \hline
...
\subsubsection{Operazione 1.4 - Creazione Tiles}
    ...
    \centerline{\begin{tabular}{ |c|c|l|c| }
        ...
        Expansion & E & 1 & L \\
        \hline
        Using(Expansion-ExpansionTile) & R & 5 & L \\
        \hline
        BasicTile & R & 17 & L \\
        \hline
        TileType & E & 22 & L \\
        \hline
        Classification(TileType-Tile) & R & 72 & S \\
        \hline
        Tile & E & 72 & S \\
        \hline
        Description & R & 325 & L \\
        ...
        \hline
        Composition(TileTypeConfiguration-GamesetType) & R & 325 & L \\
        \hline
        GamesetType & E & 5 & L \\
        \hline
        Classification(GamesetType-Gameset) & R & 150 & S \\
        \hline
        Gameset & E & 150 & S \\
        \hline
        Composition(TileTypeConfiguration-TileSectionType) & R & 325 & L \\
        \hline
        TileSectionType & E & 13 & L \\
        \hline
        Classification(TileSectionType-TileSection) & R & 806 & S \\
        \hline
        Composition(TileSection-Gameset) & R & 806 & S \\
        \hline
        Composition(TileSection-Tile) & R & 806 & S \\
        \hline
        TileSection & E & 806 & S \\
        \hline
        Preceding & R & 12 & S \\
...
\subsubsection{Operazione 9 - Piazzare la tessera corrente}
    ...
    \centerline{\begin{tabular}{ |c|c|l|c| }
        ...
        Tile & E & 2 & S \\
        \hline
        Composition(Tile-TileSection) & R & 12 & L \\
        \hline
        TileSection & E & 12 & L\\
        \hline
        Composition(TileSection-Gameset) & R & 12 & S \\
        \hline
        Gameset & R & 12 & S \\
        \hline
        Classification(Gameset-GamesetType) & R & 12 & S \\
        \hline
...
\subsubsection{Operazione 19 - Mostrare per ogni giocatore il numero di avversari con cui ha giocato}
    \centerline{\begin{tabular}{ |c|c|l|c| }
        ...
        Player & E & 40 & L \\
        \hline
        Participation(Player-PlayerInGame) & R & 40 & L \\
        \hline
        PlayerInGame & R & 40 & L \\
        \hline
...
\centerline{\begin{tabular}{ |c|c|l|c| }
    ...
    & & \textbf{Totale:} 2S $\to$ 350 al giorno & \\
    \hline
    \multicolumn{3}{|l|}{\textbf{Costo Totale} = 2*2*350 = \textbf{1400}}
    \hline
\end{tabular}}
...
\centerline{\begin{tabular}{ |c|c|l|c| }
    ...
    \hline
    \multicolumn{3}{|l|}{\textbf{Costo Totale} = (1 + 2) * 350 = \textbf{1050}}
    \hline
\end{tabular}}
...
\centerline{\begin{tabular}{ |c|c|l|c| }
    ...
    & & \textbf{Totale:} 3L $\to$ 700 al giorno & \\
    \hline
    \multicolumn{3}{|l|}{\textbf{Costo Totale} = 3*700 = \textbf{2100}}
    \hline
\end{tabular}}
Senza la ridondanza:
\centerline{\begin{tabular}{ |c|c|l|c| }
    ...
    \hline
    \multicolumn{3}{|l|}{\textbf{Costo Totale} = 4*700 = \textbf{2800}}
    \hline
\end{tabular}}
...
\subsubsection{Operazione 15 - Visualizzare le partite non concluse}
    \centerline{\begin{tabular}{ |c|c|l|c| }
        ...
        & & \textbf{Totale:} 10L $\to$ 5 al giorno & \\
        \hline
        \multicolumn{3}{|l|}{\textbf{Costo Totale} = 10*5 = \textbf{50}}
        \hline
    \end{tabular}}
...
\subsubsection{Operazione 15 - Visualizzare le partite non concluse}
    \centerline{\begin{tabular}{ |c|c|l|c| }
        ...
        & & \textbf{Totale:} 1250L $\to$ 5 al giorno & \\
        \hline
        \multicolumn{3}{|l|}{\textbf{Costo Totale} = 1250*5 = \textbf{6250}}
        \hline
    \end{tabular}}
